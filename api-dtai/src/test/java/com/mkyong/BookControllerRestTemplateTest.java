...
//
//import org.cages.controller.AgentCAGES;
//import org.cages.controller.BookRepository;
...
//    @Before
//    public void init() {
//        AgentCAGES book = new AgentCAGES(1L, "Book Name", "Mkyong", new BigDecimal("9.99"));
...
//
//        List<AgentCAGES> books = Arrays.asList(
//                new AgentCAGES(1L, "Book A", "Ah Pig", new BigDecimal("1.99")),
//                new AgentCAGES(2L, "Book B", "Ah Dog", new BigDecimal("2.99")));
//
...
//
//        AgentCAGES newBook = new AgentCAGES(1L, "Spring Boot Guide", "mkyong", new BigDecimal("2.99"));
//        when(mockRepository.save(any(AgentCAGES.class))).thenReturn(newBook);
//
...
//        JSONAssert.assertEquals(expected, response.getBody(), false);
//
//        verify(mockRepository, times(1)).save(any(AgentCAGES.class));
//
//    }
//
//    @Test
...
//
//        AgentCAGES updateBook = new AgentCAGES(1L, "ABC", "mkyong", new BigDecimal("19.99"));
//        when(mockRepository.save(any(AgentCAGES.class))).thenReturn(updateBook);
//
...
//
//        when(mockRepository.save(any(AgentCAGES.class))).thenReturn(new AgentCAGES());
...
//
//        verify(mockRepository, times(1)).findById(1L);
//        verify(mockRepository, times(0)).save(any(AgentCAGES.class));
//    }
//
//    @Test
